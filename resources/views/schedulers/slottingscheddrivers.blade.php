  ...
  $( function() {
    ...
    $('#saveBtnDriver').click(function (e) {
        ...
        if(role_id == 3 && $("#dateOfSafetyOrientationDriver").val() == ""){
         ...
         if($("#logistics_company").val() == "" || $("#first_name").val() == "" || $("#last_name").val() == "" || $("#mobile_number").val() == "" || $("#company_id_number").val() == "" || $("#license_number").val() == "" || $("#driver_suppliers").val() == "" || $("#dateOfSafetyOrientationDriver").val() == ""){
          ...
          setTimeout(function(){
           ...
           if($("#driver_suppliers").val() == "")
            ...
            if($("#dateOfSafetyOrientationDriver").val() == "")
             $("#dateOfSafetyOrientationDriver").css('outline','1px solid red')
            else
             $("#dateOfSafetyOrientationDriver").css('outline','1px solid black')
